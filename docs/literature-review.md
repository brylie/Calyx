...
- [Calyx Literature Review](#calyx-literature-review)
  - [1. Spectral modeling synthesis](#1-spectral-modeling-synthesis)
    - [1.1 Sinusoidal plus residual models](#11-sinusoidal-plus-residual-models)
    - [1.2 Partial tracking algorithms](#12-partial-tracking-algorithms)
    - [1.3 Phase vocoder techniques](#13-phase-vocoder-techniques)
    - [1.4 IRCAM tools and research](#14-ircam-tools-and-research)
  - [2. Additive synthesis](#2-additive-synthesis)
    - [2.1 History and implementations](#21-history-and-implementations)
    - [2.2 Resynthesis from analysis data](#22-resynthesis-from-analysis-data)
  - [3. Dimensionality reduction and matrix factorization](#3-dimensionality-reduction-and-matrix-factorization)
    - [3.1 Principal Component Analysis (PCA)](#31-principal-component-analysis-pca)
    - [3.2 Non-negative Matrix Factorization (NMF)](#32-non-negative-matrix-factorization-nmf)
    - [3.3 Other decomposition methods](#33-other-decomposition-methods)
  - [4. Tensor decomposition](#4-tensor-decomposition)
    - [4.1 Foundational methods](#41-foundational-methods)
    - [4.2 CP (Canonical Polyadic) decomposition](#42-cp-canonical-polyadic-decomposition)
    - [4.3 Tucker decomposition](#43-tucker-decomposition)
    - [4.4 Tensor train and other formats](#44-tensor-train-and-other-formats)
    - [4.5 Tensor decomposition in audio and signal processing](#45-tensor-decomposition-in-audio-and-signal-processing)
  - [5. Audio compression and codecs](#5-audio-compression-and-codecs)
    - [5.1 Perceptual audio coding](#51-perceptual-audio-coding)
    - [5.2 Parametric audio coding](#52-parametric-audio-coding)
    - [5.3 Neural audio codecs](#53-neural-audio-codecs)
    - [5.4 Lossless and near-lossless audio compression](#54-lossless-and-near-lossless-audio-compression)
  - [6. Differentiable Digital Signal Processing (DDSP)](#6-differentiable-digital-signal-processing-ddsp)
  - [7. Sample library technology](#7-sample-library-technology)
    - [7.1 Current sampler formats and engines](#71-current-sampler-formats-and-engines)
    - [7.2 Commercial sample library landscape](#72-commercial-sample-library-landscape)
    - [7.3 Multi-sample organization](#73-multi-sample-organization)
  - [8. Open source audio projects and ecosystem](#8-open-source-audio-projects-and-ecosystem)
    - [8.1 Surge Synth Team](#81-surge-synth-team)
    - [8.2 Rust audio ecosystem](#82-rust-audio-ecosystem)
    - [8.3 Rust numerical computing ecosystem](#83-rust-numerical-computing-ecosystem)
    - [8.4 Other relevant open source projects](#84-other-relevant-open-source-projects)
  - [9. Perceptual quality evaluation](#9-perceptual-quality-evaluation)
    - [9.1 Objective metrics](#91-objective-metrics)
    - [9.2 Perceptual quality in musical context](#92-perceptual-quality-in-musical-context)
  - [10. Patent landscape](#10-patent-landscape)
    - [10.1 Areas of concern](#101-areas-of-concern)
    - [10.2 Patent mitigation](#102-patent-mitigation)
  - [11. Gaps and opportunities](#11-gaps-and-opportunities)
